...
class Cosmo::HttpLib < Cosmo::IntrinsicLib
  def inject : Nil
    http = {} of String => Hash(String, IntrinsicFunction) | IntrinsicFunction
  ...
  abstract class Client::ResponseBodyFunctionBase < IntrinsicFunction
  ...
  class Client::Fetch < IntrinsicFunction
    ...
    def call(args : Array(ValueType)) : Nil
      ...
      wrapped_body = {} of String => IntrinsicFunction
      ...
      wrapped_res = {} of String => String | Int64 | Hash(String, IntrinsicFunction)
