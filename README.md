...
Download the [Cosmo Installer](https://github.com/cosmo-lang/cosmo-installer/releases) and run it.<br>
...
There is a guide about how to contribute [here](https://github.com/cosmo-lang/cosmo/wiki) on our Wiki.<br>
You can find any documentation you might need to contribute [here](https://cosmo-lang.github.io/cosmo). It's a page automatically generated by Crystal containing documentation for all classes, modules, etc.
...
Have any questions or comments? DM me or @ me in [my server](https://discord.gg/WHyHh39dwh) on Discord.
